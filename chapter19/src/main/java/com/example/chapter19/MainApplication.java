...
import com.example.chapter19.database.PersonDatabase;

public class MainApplication extends Application {
    private final static String TAG = "MainApplication";
    private static MainApplication mApp; // 声明一个当前应用的静态实例
    private PersonDatabase personDatabase; // 声明一个人员数据库对象
    ...
    public void onCreate() {
        ...
        // 构建人员数据库的实例
        personDatabase = Room.databaseBuilder(mApp, PersonDatabase.class,"PersonInfo")
    ...
    // 获取人员数据库的实例
    public PersonDatabase getPersonDB(){
