...
package com.example.hmsml.text.camera;
...
public class LensEngine {
    ...
    public LensEngine(Activity activity, com.example.hmsml.text.camera.CameraConfiguration configuration, GraphicOverlay graphicOverlay) {
